...
rows.each do |row|
	...
	print t1, "  ", t2, "  ", t3, "\n"
	client.query("insert into xhb_cftc_data values(null, '#{t1}', '#{t2}', '#{t3}', 1);")
end
...
rows2.each do |row|
	...
	t3 = tds[2].text.to_s.gsub(/(\&nbsp;)|(\s)/, "").strip
	print t1, "  ", t2, "  ", t3, "\n"
	client.query("insert into xhb_cftc_data values(null, '#{t1}', '#{t2}', '#{t3}', 2);")
end
...
rows3.each do |row|
	...
	print t1, "  ", t2, "  ", t3, "\n"
	client.query("insert into xhb_cftc_data values(null, '#{t1}', '#{t2}', '#{t3}', 3);")
end
...
rows4.each do |row|
	...
	t3 = tds[2].text.to_s.gsub(/(\&nbsp;)|(\s)/, "").strip
	print t1, "  ", t2, "  ", t3, "\n"
	client.query("insert into xhb_cftc_data values(null, '#{t1}', '#{t2}', '#{t3}', 4);")
end
...
rows5.each do |row|
	...
	t3 = tds[2].text.to_s.gsub(/(\&nbsp;)|(\s)/, "").strip
	print t1, "  ", t2, "  ", t3, "\n"
	client.query("insert into xhb_cftc_data values(null, '#{t1}', '#{t2}', '#{t3}', 5);")
end